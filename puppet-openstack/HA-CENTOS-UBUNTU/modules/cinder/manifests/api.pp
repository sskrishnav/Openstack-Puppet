...
class cinder::api (
  ...
  Cinder_api_paste_ini<||> ~> Service["$::cinder::params::api_service"]
  Class['cinder::policy'] ~> Service["$::cinder::params::api_service"]
 

  if $::cinder::params::api_package {
    Package["$::cinder::params::api_package"] -> Class['cinder::policy']
    Package["$::cinder::params::api_package"] -> Cinder_config<||>
    Package["$::cinder::params::api_package"] -> Cinder_api_paste_ini<||>
    Package["$::cinder::params::api_package"] -> Service["$::cinder::params::api_service"]
    Package["$::cinder::params::api_package"] ~> Exec<| title == 'cinder-manage db_sync' |>
    package { "$::cinder::params::api_package":
  ...
  if $sync_db {
    ...
    exec { 'cinder-manage db_sync':
        ...
        subscribe   => Package["$::cinder::params::package_name"],
        before      => Service["$::cinder::params::api_service"],
    }
  }
  ...
  if $validate {
    ...
    create_resources('openstacklib::service_validation', $validation_options_hash, {'subscribe' => 'Service["$::cinder::params::api_service"]'})
