...
class ceilometer::api (
  ...
  Ceilometer_config<||> ~> Service["$::ceilometer::params::api_service_name"]
  Class['ceilometer::policy'] ~> Service["$::ceilometer::params::api_service_name"]
  Package["$::ceilometer::params::api_package_name"] -> Ceilometer_config<||>
  Package["$::ceilometer::params::api_package_name"] -> Service["$::ceilometer::params::api_service_name"]
  Package["$::ceilometer::params::api_package_name"] -> Class['ceilometer::policy']
  package { "$::ceilometer::params::api_package_name":
  ...
  Package["$::ceilometer::params::common_package_name"] -> Service["$::ceilometer::params::api_service_name"]
  service { "$::ceilometer::params::api_service_name":
  ...
  if $keystone_auth_uri {
    ceilometer_config {
      ...
      'keystone_authtoken/identity_uri': value => "${keystone_protocol}://${keystone_host}:35357";
    }
  } else {
    ceilometer_config {
      'keystone_authtoken/auth_uri': value => "${keystone_protocol}://${keystone_host}:5000/v2.0";
      'keystone_authtoken/identity_uri': value => "${keystone_protocol}://${keystone_host}:35357";
    }
  }
