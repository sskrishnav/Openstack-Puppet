...
class neutron::agents::metadata (
  ...
  if $::osfamily == 'Debian' {
     Package['neutron-common'] -> Neutron_metadata_agent_config<||>
  }
  elsif $::osfamily == 'RedHat' {
     Package['openstack-neutron'] -> Neutron_metadata_agent_config<||>
  }
  ...
  neutron_metadata_agent_config {
    ...
    'DEFAULT/project_name'     :              value => $auth_tenant;
    'DEFAULT/project_domain_id':              value => $domain_id;
    'DEFAULT/user_domain_id'   :	      value => $domain_id;
    'DEFAULT/username'         :              value => $auth_user;
    'DEFAULT/password'         :              value => $auth_password, secret => true;
