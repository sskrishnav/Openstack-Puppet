...
class galera::repo(
  ...
  #$apt_mariadb_repo_location = 'http://ams2.mirrors.digitalocean.com/mariadb/repo/5.5/ubuntu',
  $apt_mariadb_repo_release = $::lsbdistcodename,
  $apt_mariadb_repo_repos = 'main',
  $apt_mariadb_repo_key = '1BB943DB',
  $apt_mariadb_repo_key_server = 'keys.gnupg.net:80',
  #$apt_mariadb_repo_key = '0xcbcb082a1bb943db',
  #$apt_mariadb_repo_key_server = 'keyserver.ubuntu.com:80',
  ...
  $yum_mariadb_baseurl = 'http://yum.mariadb.org/10.0/rhel7-amd64/',
