...
class openstack::profile::haproxy {
    ...
    if $::osfamily == 'Debian' {
        ...
        Anchor['haproxy2::start'] -> Haproxy::Balancermember<||> -> Package['openstack-glance-api'] -> Package['openstack-glance-registry'] -> Package['openstack-cinder-api'] -> Package['openstack-heat-api'] -> Exec<| title == 'keystone-manage db_sync' |> -> Exec<| title == 'glance-manage db_sync' |> -> Exec<| title == 'nova-db-sync' |> -> Exec<| title == 'neutron-db-sync' |> -> Exec<| title == 'cinder-manage db_sync' |> -> Exec<| title == 'heat-dbsync' |> -> Anchor['haproxy2::end']
    }
    ...
    if $::osfamily == 'Debian' {
       ...
       Haproxy::Balancermember<||> -> Package['openstack-glance-api']
       Service['haproxy'] -> Package['opesnstack-glance-api']
       Haproxy::Balancermember<||> -> Package['openstack-glance-registry']
       Service['haproxy'] -> Package['openstack-glance-registry']
       Haproxy::Balancermember<||> -> Package['openstack-cinder']
       Service['haproxy'] -> Package['openstack-cinder']
       Haproxy::Balancermember<||> -> Package['openstack-cinder-api']
       Service['haproxy'] -> Package['openstack-cinder-api']
       Haproxy::Balancermember<||> -> Package['openstack-heat-api']
       Service['haproxy'] -> Package['openstack-heat-api']
       Haproxy::Balancermember<||> -> Package['openstack-ceilometer-api']
       Service['haproxy'] -> Package['openstack-ceilometer-api']
       Haproxy::Balancermember<||> -> Exec<| title == 'keystone-manage db_sync' |>
       Service['haproxy'] -> Exec<| title == 'keystone-manage db_sync' |>
       Haproxy::Balancermember<||> -> Exec<| title == 'glance-manage db_sync' |>
       Service['haproxy'] -> Exec<| title == 'glance-manage db_sync' |>
    ...
    mysql_user {"haproxy@$192.168.57.101":
        ensure => 'present',
    }
