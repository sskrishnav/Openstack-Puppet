...
WEBROOT = '/'
LOGIN_URL = WEBROOT + 'castlight/login/'
LOGOUT_URL = WEBROOT + 'castlight/logout/'

FLAVOR_DEV = "tiny"
FLAVOR_WEB = "small"
FLAVOR_DB = "medium"

IMAGE_NAME_DEV = "cirros-0.3.3-x86_64"
IMAGE_NAME_TEST = "cirros-0.3.3-x86_64"
IMAGE_NAME_QA = "cirros-0.3.3-x86_64"
IMAGE_NAME_SIGNOFF = "cirros-0.3.3-x86_64"
#
...
#TEMPLATE_DIRS = (
#    os.path.join('/usr/share/openstack-dashboard/openstack_dashboard/dashboards/castlight', 'templates'),
#)

#STATIC_ROOT = '/usr/share/openstack-dashboard/openstack_dashboard/dashboards/castlight'
