...
class glance::api(
  ...
  Exec<| title == 'glance-manage db_sync' |> ~> Service[$::glance::params::api_service_name]
  Glance_api_config<||>   ~> Service[$::glance::params::api_service_name]
  Glance_cache_config<||> ~> Service[$::glance::params::api_service_name]
  Class['glance::policy'] ~> Service[$::glance::params::api_service_name]
  Service[$::glance::params::api_service_name]   ~> Glance_image<||>
