...
define apt::force(
  ...
  case $cfg_files {
    'new':       { $config_files = '-o Dpkg::Options::="--force-confnew --force-yes"' }
    'old':       { $config_files = '-o Dpkg::Options::="--force-confold --force-yes"' }
    'unchanged': { $config_files = '-o Dpkg::Options::="--force-confdef --force-yes"' }
    'none':      { $config_files = '' }
  }

  case $cfg_missing {
    true:    { $config_missing = '-o Dpkg::Options::="--force-confmiss --force-yes"' }
