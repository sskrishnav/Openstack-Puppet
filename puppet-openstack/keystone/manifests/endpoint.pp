...
class keystone::endpoint (
  ...
  notice("in keystone::endpoint file ----------->")
  notice("$host, $public_url, $internal_url, $admin_url, $version, $region")
  ...
  notice("$public_url_real, $admin_url_real, $internal_url_real, $region")
