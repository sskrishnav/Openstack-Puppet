...
import horizon
#print "test:",openstack_auth.__file__
urlpatterns = patterns(
    '',
    url(r'^$', 'openstack_dashboard.views.splash', name='splash'),
    url(r'^api/', include('openstack_dashboard.api.rest.urls')),
    url(r'', include(horizon.urls)),
    url(r'^castlight/', include('openstack_dashboard.dashboards.castlight.urls')),
)

"""urlpatterns += patterns('openstack_auth.views',
	url(r'^horizon/auth/login/$','login',name='login'),
	url(r'^horizon/auth/logout/$','logout',name='logout')
)"""
