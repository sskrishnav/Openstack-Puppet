...
class ceilometer::api (
  ...
  if $::osfamily == 'Debian' {
    ...
    Ceilometer_config<||> ~> Service['openstack-ceilometer-api']
    Class['ceilometer::policy'] ~> Service['openstack-ceilometer-api']
    Package['openstack-ceilometer-api'] -> Ceilometer_config<||>
    Package['openstack-ceilometer-api'] -> Service['openstack-ceilometer-api']
    Package['openstack-ceilometer-api'] -> Class['ceilometer::policy']
  ...
  if $::osfamily == 'Debian' {
    ...
    Package['openstack-ceilometer-common'] -> Service['openstack-ceilometer-api']
