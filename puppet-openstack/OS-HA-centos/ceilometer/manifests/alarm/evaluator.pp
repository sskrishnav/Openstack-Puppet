...
class ceilometer::alarm::evaluator (
  ...
  if $::osfamily == "RedHat" {
     Ceilometer_config<||> ~> Service['openstack-ceilometer-alarm-evaluator']

     Package[$::ceilometer::params::alarm_package_name] -> Service['openstack-ceilometer-alarm-evaluator']
     Package[$::ceilometer::params::alarm_package_name] -> Package<| title == 'ceilometer-alarm' |>
     ensure_packages($::ceilometer::params::alarm_package_name)
    ...
    Package['openstack-ceilometer-common'] -> Service['openstack-ceilometer-alarm-evaluator']
