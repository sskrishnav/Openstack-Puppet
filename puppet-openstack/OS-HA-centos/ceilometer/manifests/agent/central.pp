...
class ceilometer::agent::central (
  ...
  if $::osfamily == 'Debian' {
    ...
    Ceilometer_config<||> ~> Service['openstack-ceilometer-agent-central']

    Package['openstack-ceilometer-agent-central'] -> Service['openstack-ceilometer-agent-central']
    package { 'openstack-ceilometer-agent-central':
      ensure => $package_ensure,
      name   => $::ceilometer::params::agent_central_package_name,
    }
    ...
    Package['openstack-ceilometer-common'] -> Service['openstack-ceilometer-agent-central']
