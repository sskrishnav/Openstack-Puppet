...
class swift::storage::object(
  ...
  Swift_config<| |> ~> Service['openstack-swift-object-updater']
  Swift_config<| |> ~> Service['openstack-swift-object-auditor']
  ...
  service { 'openstack-swift-object-updater':
  ...
  service { 'openstack-swift-object-auditor':
    ensure   => $service_ensure,
