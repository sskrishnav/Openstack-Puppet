...
class heat::api (
  ...
  if $::osfamily == "Debian" {
    ...
    Heat_config<||> ~> Service['openstack-heat-api']
    Class['heat::policy'] -> Service['openstack-heat-api']

    Package['openstack-heat-api'] -> Heat_config<||>
    Package['openstack-heat-api'] -> Class['heat::policy']
    Package['openstack-heat-api'] -> Service['openstack-heat-api']
  }
