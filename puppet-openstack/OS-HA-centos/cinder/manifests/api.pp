...
class cinder::api (
  ...
  if $::osfamily == 'Debian' {
    ...
    Cinder_config<||> ~> Service['openstack-cinder-api']
    Cinder_api_paste_ini<||> ~> Service['openstack-cinder-api']
    Class['cinder::policy'] ~> Service['openstack-cinder-api']
  }
  ...
  if $::cinder::params::api_package {
    ...
    if $::osfamily == 'RedHat' {
       Package['cinder-api'] -> Service['openstack-cinder-api']
    }
  ...
  if $sync_db {
    ...
    if $::osfamily == 'Debian' {
      ...
      exec { 'cinder-manage db_sync':
        ...
        refreshonly => true,
        logoutput   => 'on_failure',
        subscribe   => Package['openstack-cinder'],
        before      => Service['openstack-cinder-api'],
      }
    }
  }
  ...
  if $validate {
    ...
    if $::osfamily == 'Debian' {
      ...
      create_resources('openstacklib::service_validation', $validation_options_hash, {'subscribe' => 'Service[openstack-cinder-api]'})
    }
  }
